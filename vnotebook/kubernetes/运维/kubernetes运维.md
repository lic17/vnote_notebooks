...
```
kubectl -n yimeitest run -i --tty --rm debug --image=curlimages/curl:7.68.0 --restart=Never -- sh
```

## ipvs模式内核配置项：
```
yum -y install ipvsadm ipset
scp /etc/sysconfig/modules/ipvs.modules  ${node}:/etc/sysconfig/modules/ipvs.modules
